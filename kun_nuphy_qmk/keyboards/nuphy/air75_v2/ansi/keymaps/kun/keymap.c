...
// Default Layout *MAC*
[0] = LAYOUT_ansi_84(
	KC_GRV, TO(0), TO(2), TO(3), KC_F4, TO(4), TO(5), KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR, KC_INS, GE_SWAP,
...
// GAME_LAYER
[5] = LAYOUT_ansi_84(
	_______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, _______, _______, _______, _______, _______, _______, _______, _______, _______,
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
