...
[0] = LAYOUT_ansi_84(
	...
	KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, LT(1, KC_SCLN), KC_QUOT, KC_ENT, KC_HOME,
	KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_END,
	LT(1, KC_CAPS), KC_LGUI, KC_LALT, KC_SPC, KC_RALT, _______, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
...
[2] = LAYOUT_ansi_84(
	...
	_______, KC_LEFT, KC_DOWN, KC_RGHT, C(KC_RGHT), _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_SCLN, _______, _______, _______,
	_______, KC_PGUP, KC_PGDN, KC_BSPC, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
	_______, _______, _______, TO(0), _______, _______, _______, _______, _______, _______),
